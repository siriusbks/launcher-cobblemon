...
class Settings {
    ...
    async javaPath() {
        ...
        let configClient = await this.db.readData('configClient')
        let javaPath = configClient?.java_config?.java_path || 'Currently Using: the Java Version from Mojang';
        ...
        document.querySelector(".java-path-set").addEventListener("click", async () => {
            ...
            } else alert("Error: File name must be java or javaw");
        });

        document.querySelector(".java-path-reset").addEventListener("click", async () => {
            let configClient = await this.db.readData('configClient')
            javaPathInputTxt.value = 'Currently Using: the Java Version from Mojang';
